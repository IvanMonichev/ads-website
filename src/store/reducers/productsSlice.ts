  ...
  products: [
    {
      ...
      description:
        'Просторная двушка в центре Питера. Без кухни, зато в историческом здании. Внизу много кафешек, поесть можно и там. Есть выход на крышу, с которой виден весь город. В собственности больше трёх лет.',
      address: {
    ...
    },
    {
      ...
      description:
        'Уютная однушка в тихом спальном районе. Рядом лес и озёра. Согласованная перепланировка. Тонкие стены — вы будете слышать соседей, зато будете в курсе всех событий.',
      address: {
        city: 'Санкт-Петербург',
    ...
    },
    {
      ...
      description:
        'Трёхкомнатная квартира для большой семьи рядом с Кремлём. 2 минуты до набережной и прекрасного вида на Волгу. Сделана шумоизоляция — вы не будете слышать туристов, а они не будут слышать вас. В квартире есть сауна, джакузи и домашний кинотеатр. Перепланировка согласованна.',
      address: {
    ...
    },
    {
      ...
      description:
        'Студия с лаконичным дизайном возле Ангары. Квартира небольшая, но в ней есть всё необходимое для комфортной одинокой жизни. Балкона нет, зато есть большое окно, выходящее во двор. На подоконник часто прилетают голуби, вы сможете с ними подружиться.',
      address: {
        city: 'Иркутск',
        street: 'ул. Полярная',
        building: 'д.95А'
    ...
    },
    {
      ...
      description:
        'Уютные апартаменты в центре города. Большие окна, много света. Нет кабинета, но за кухонных столом удобно работать. Есть небольшая комната для приёма гостей.',
      address: {
        city: 'Красноярск',
        street: 'ул. Шахтёров',
        building: 'д.33Б'
    ...
    },
    {
      ...
      description:
        'Большие стильные апартаменты для семьи без детей. Большая кухня с островом для ваших лучших ужинов. Просторная гостиная. Из окон вид на вулканы.',
      address: {
      ...
      category: 'Недвижимость',
      photos: [
        'https://assets.htmlacademy.ru/content/projects/1-trading-floor/apt_6_1.png',
        'https://assets.htmlacademy.ru/content/projects/1-trading-floor/apt_6_2.png',
        'https://assets.htmlacademy.ru/content/projects/1-trading-floor/apt_6_3.png'
      ],
      filters: {
        type: 'apartment',
        area: 85,
    ...
    },
    {
      ...
      category: 'Недвижимость',
      photos: [
        'https://assets.htmlacademy.ru/content/projects/1-trading-floor/house_1_1.png',
        'https://assets.htmlacademy.ru/content/projects/1-trading-floor/house_1_2.png',
        'https://assets.htmlacademy.ru/content/projects/1-trading-floor/house_1_3.png',
        'https://assets.htmlacademy.ru/content/projects/1-trading-floor/house_1_4.png',
        'https://assets.htmlacademy.ru/content/projects/1-trading-floor/house_1_5.png',
        'https://assets.htmlacademy.ru/content/projects/1-trading-floor/house_1_6.png',
        'https://assets.htmlacademy.ru/content/projects/1-trading-floor/house_1_7.png'
      ],
      filters: {
        type: 'house',
        area: 105,
    ...
    },
    {
      ...
      description:
        'Кирпичный дом в американском стиле в Курортном районе. Большая просторная кухня, много света, гардеробная, кладовка, бассейн, гараж. Рядом Сестрорецкий разлив и залив. В 5 минутах от дома садик и школа. В 10 минутах продуктовый магазин и железнодорожная станция.',
      address: {
        city: 'Сестрорецк',
      ...
      category: 'Недвижимость',
      photos: [
        'https://assets.htmlacademy.ru/content/projects/1-trading-floor/house_2_1.png',
        'https://assets.htmlacademy.ru/content/projects/1-trading-floor/house_2_2.png',
        'https://assets.htmlacademy.ru/content/projects/1-trading-floor/house_2_3.png',
        'https://assets.htmlacademy.ru/content/projects/1-trading-floor/house_2_4.png'
      ],
      filters: {
        type: 'house',
        area: 150,
    ...
    },
    {
      ...
      description:
        'В хорошем состоянии, пробег 100000 км, в аварии не попадала, есть подушки безопасности. Зимнюю резину отдам в подарок.',
      address: {
        city: 'Москва',
        street: 'ул. Одесская',
    ...
    },
    {
      ...
      description:
        'Новенький Porshе с кожаным салоном, парктроником, электроприводом передних сидений. Есть подогрев зеркал, усилитель руля и камера заднего вида.',
      address: {
        city: 'Москва',
        street: 'ул. Одесская',
        building: 'д.22 корпус 4'
    ...
    },
    {
      ...
      description:
        "Пробег 922 км. Юбилейная серия Luxe '40th Anniversary'. Состояние нового автомобиля. Установлен съемный фаркоп, бесшумные рычаги раздаточной коробки.",
      address: {
        city: 'Санкт-Петербург',
      ...
      category: 'Автомобиль',
      photos: [
        'https://assets.htmlacademy.ru/content/projects/1-trading-floor/car_3_1.png',
        'https://assets.htmlacademy.ru/content/projects/1-trading-floor/car_3_2.png',
        'https://assets.htmlacademy.ru/content/projects/1-trading-floor/car_3_3.png'
      ],
      filters: {
    ...
    },
    {
      ...
      description:
        'Пробег 605000 км, состояние хорошее. Небольшой расход топлива. Полный привод. Постоянное обслуживание. Низкая цена из-за большого пробега. Максимальная комплектация. Надежный двигатель v6. Возможен торг. Прошу автосалоны меня не беспокоить.',
      address: {
        city: 'Санкт-Петербург',
        street: 'ул. Львовская',
      ...
      category: 'Автомобиль',
      photos: [
        'https://assets.htmlacademy.ru/content/projects/1-trading-floor/car_4_1.png',
        'https://assets.htmlacademy.ru/content/projects/1-trading-floor/car_4_2.png',
        'https://assets.htmlacademy.ru/content/projects/1-trading-floor/car_4_3.png'
      ],
      filters: {
    ...
    },
    {
      ...
      description:
        'Пробег 225000 км, состояние хорошее, коррозии нет. Сзади новые амортизаторы, обновлена подвеска. Есть подушки безопасности.',
      address: {
        city: 'Санкт-Петербург',
        street: 'ул. Львовская',
        building: 'д.19 корпус 2'
    ...
    },
    {
      ...
      description:
        'В хорошем состоянии, аккумулятор держит около трёх часов. Есть две небольшие вмятины на крышке, на работу никак не влияют. Царапин нет. В подарок отдам пластиковый чехол.',
      address: {
        city: 'Моршанск',
    ...
    },
    {
      ...
      description:
        'На гарантии. Куплен 3 месяца назад за 65990 рублей. Нужно заменить матрицу. Продаю из-за ненадобности. Всё работает идеально. Кроме экрана. Готов поменять на айфон.',
      address: {
        city: 'Челябинск',
    ...
    },
    {
      ...
      description:
        'Популярный Asus N-серии, отлично справится с любыми задачами. К тому же имеет FullHD матрицу. Торопитесь, такая привлекательная цена будет ещё две недели! К ноутбуку подарим мышку!',
      address: {
    ...
    },
    {
      ...
      description:
        'Продаём ноутбук без жесткого диска, но с зарядным устройством. С экраном проблемы, но на работу самого ноутбука это не влияет, он работает исправно. Подарим мышку. При личном визите угостим печеньками!',
      address: {
        city: 'садовое товарищество Хуторок',
        street: 'ул. Берёзовая',
        building: 'д.140'
      ...
      category: 'Ноутбук',
      photos: [
        'https://assets.htmlacademy.ru/content/projects/1-trading-floor/laptop_4_1.png',
        'https://assets.htmlacademy.ru/content/projects/1-trading-floor/laptop_4_2.png',
        'https://assets.htmlacademy.ru/content/projects/1-trading-floor/laptop_4_3.png'
      ],
      filters: {
        type: 'home',
        'ram-value': '-',
    ...
    },
    {
      ...
      description:
        'Хорошая альтернатива яблочным ноутбукам. Тонкий, стильный, лёгкий. Прочный корпус из металла и углеродного волокна. Подсветка клавиатуры с изменяемой яркостью в зависимости от освещения. Бесшумный. Работа без подзарядки до 10 часов.',
      address: {
        city: 'Хабаровск',
        street: 'ул. Павловича',
        building: 'д.6'
      ...
      category: 'Ноутбук',
      photos: [
        'https://assets.htmlacademy.ru/content/projects/1-trading-floor/laptop_5_1.png',
        'https://assets.htmlacademy.ru/content/projects/1-trading-floor/laptop_5_2.png',
        'https://assets.htmlacademy.ru/content/projects/1-trading-floor/laptop_5_3.png'
      ],
      filters: {
        type: 'ultrabook',
        'ram-value': '-',
    ...
    },
    {
      ...
      description:
        'Профессиональная полнокадровая фотокамера. Фотографии с разрешением 6016х4016 px. Запись видео с разрешением 1920х1080. Съемка 6 кадров в сек. Съемные объективы. Автофокусировка. В комплекте флешки на 64 и 16 гб, зарядник для батареек.',
      address: {
    ...
    },
    {
      ...
      description:
        '2 аккумулятора, зарядное, 2 объектива. Чехол для фотоаппарата. Активно не использовали, сняли свадьбу и выпускной, после этого лежит без дела. На двух объективах сразу поставили фильтр Flama.',
      address: {
        city: 'Оренбург',
    ...
    },
    {
      ...
      description:
        'Отлично подходит для изучения азов фотографии. Прост в обращении, неприхотлив. Не бит, не крашен, в экстремальных ситуациях не был, под дождем не мок. На объективе есть защитный фильтр. В комплекте зарядка и чехол Lowepro. Установочный диск, документы и коробка потеряны, не знаю, где их найти.',
      address: {
        city: 'Уфа',
    ...
    },
    {
      ...
      description:
        'Пробег 9000 кадров. В основном использовался для видеосъемки. Состояние очень хорошее. Покупался весной прошлого года. Коробка, инструкция, чеки есть. На дисплее оригинальная защитная пленка. В комплексе зарядка. Продаю потому что перешёл на другую модель.',
      address: {
        city: 'коттеджный посёлок Николин Ручей',
        street: 'ул. Рябиновая',
        building: 'д.13'
      ...
      category: 'Фотоаппарат',
      photos: [
        'https://assets.htmlacademy.ru/content/projects/1-trading-floor/cam_4_1.png',
        'https://assets.htmlacademy.ru/content/projects/1-trading-floor/cam_4_2.png',
        'https://assets.htmlacademy.ru/content/projects/1-trading-floor/cam_4_3.png',
        'https://assets.htmlacademy.ru/content/projects/1-trading-floor/cam_4_4.png',
        'https://assets.htmlacademy.ru/content/projects/1-trading-floor/cam_4_5.png',
        'https://assets.htmlacademy.ru/content/projects/1-trading-floor/cam_4_6.png'
      ],
      filters: {
        type: 'slr',
        'matrix-resolution': '-',
